/**
 * FoodCatalog
 * Unica fuente de verdad de los alimentos del juego.
 *
 * Para agregar un alimento:
 *   1. Copia el PNG en assets/images/food/
 *   2. Agrega UNA entrada aqui (file + label + healthyLevel)
 *
 * Labels con acentos usan \uXXXX para evitar problemas de encoding.
 ...
 *   4  = muy saludable
 *   3  = saludable
 *   2  = aceptable / saludable pero poco tipico de desayuno
 *   1  = poco recomendable
